...
public class KuisActivity3 extends AppCompatActivity {
    ...
    public void tampilDialog() {
        ...
        builder.setMessage("Jawaban anda benar : Merah Putih");
        builder.setPositiveButton("Berikutnya", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Intent next = new Intent(KuisActivity3.this,FinishActivity.class);
                startActivity(next);
            }
        });
